# sim_top.do - test integracyjny calego toru AEGIS-ZERO z automatycznym scoreboardem Osoby 3
...
# Pliki inicjalizacyjne RAM/Bloom. Musza byc w katalogu roboczym symulacji,
# bo RTL i testbench uzywaja $readmemh z nazwami wzglednymi.
...
add wave -hex sim:/tb_aegis_zero_top/uut/src_ip_after_bloom
...
add wave -unsigned sim:/tb_aegis_zero_top/q_tail
add wave -unsigned sim:/tb_aegis_zero_top/bloom_head
add wave -unsigned sim:/tb_aegis_zero_top/lhd_head
add wave -unsigned sim:/tb_aegis_zero_top/bram_head
add wave -unsigned sim:/tb_aegis_zero_top/decision_head
add wave -unsigned sim:/tb_aegis_zero_top/pass_count
add wave -unsigned sim:/tb_aegis_zero_top/fail_count
